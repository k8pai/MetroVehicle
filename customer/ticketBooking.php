...
<html lang="en">
  ...
  <div id="mySidenav" class="sidenav text-light bg-dark" style="height: 130vh;">
    <div class="closebtn-div">
      <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
    </div>
    <a href="customerHome.php" >Home</a>
    <a href="ticketRates.php">Ticket Rates</a>
    <a class="active-page" href="ticketBooking.php">Booking</a>
  ...
  <nav id="navbar" class="navbar text-white bg-dark">
    ...
    <span class="navbar-vert-line"></span>
  ...
  <div class="section">
    <div class="container">
      <div class="card text-dark bg-transparent mb-3 shadow-lg">
        <form action="actionPages/bandaction.php" method="post">
