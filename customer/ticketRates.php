  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
      <div class="abc-1" style="height: 100%; width: 100%;">
        <div class="abc-2"style="min-height: 100%; width: 100%; border: none;">
            <div class="abc-3">
              <div id="mySidenav" class="sidenav bg-dark shadow-lg">
            ...
            <div class="section">
              ...
              <div class="card text-dark bg-transparent mb-3 shadow-lg">
                ...
                <div class="card-body" style="width: 550px;">
                  ...
                  <div class="input1">
                    <input type="submit" class="form-control btn shadow-lg" name="btn-functional" data-bs-toggle="modal" data-bs-target="#staticBackdrop" value="view details" style="letter-spacing: 5px; transition: 0.4s; margin: 20px; width: fit-content; border-radius: 7px; border: 1px solid;">
                  </div>
                  </form>
                  <!-- Modal -->
