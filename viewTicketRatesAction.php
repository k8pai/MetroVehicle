...
<html lang="en">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="customer/css/commonStyles.css">
  ...
  <nav id="navbar" class="navbar sticky-top text-white bg-dark">
    <a class="menu-btn" id="Menu-open" onclick="dropMenu()"><img src="baseline_menu_white_24dp.png"></a>
    <span class="nav-divider"></span>
    <span class="header" style="flex:1;"><h3>Metro By Vehicles</h3></span>
    <div class="header-right" style=" right: 20px;">
      <a href="customerHome.php"><img src="customer/icons8/icons8-homepage-64.png" style="font-size: 48px;"></a>
    </div>
  </nav> 
  <div class="section">
  	<div class="container">
