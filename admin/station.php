...
<html lang="en">
  <head>
   ...
   <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&display=swap" rel="stylesheet">
    ...
    <title>Station Modification | MBV</title>
  ...
  <div id="mySidenav" class="sidenav bg-dark text-light" style="height: 130vh;">
    ...
    <div class="sidenav-div">
      ...
      <a class="active-page" href="station.php">Station</a>
      ...
      <div class="sec">
        <div class="card text-dark bg-transparent mb-3 shadow-lg">
          ...
          <div class="card-body" style="width: 550px;">
            <form action="actionPages/stationaction.php" method="post">
            <div class="input1">
              <input type="text" class="form-control shadow-lg" placeholder=" Station Code " aria-label="Station code" name="scode" required>
            </div>
            <div class="input1">
      ...
      <div class="sec">
        <div class="card text-dark bg-transparent mb-3 shadow-lg">
          ...
          <div class="card-body" style="width: fit-content;">
            <table class="table table-borderless shadow-lg"  style="width: 600px;">
              <thead>
              ...
              <tbody>
                <?php
                  ...
                  ?>
                    ...
                    <td><a href="actionPages/deleteStation.php?id=<?php echo $row['sCode'];?>">Delete</a></td>
                    </tr>
                  <?php $i++;} ?>
              </tbody>
            </table>
