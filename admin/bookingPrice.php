...
<html lang="en">
  <head>
   ...
   <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&display=swap" rel="stylesheet">
    ...
    <title>Booking Settings | MBV</title>
  ...
  <div id="mySidenav" class="sidenav bg-dark text-light">
    ...
    <div class="sidenav-div">
      ...
      <a class="active-page" href="bookingPrice.php">booking price</a>
  ...
  <div class="content-containers">
    <div class="container-div">
        <div class="card text-dark bg-transparent mb-3 shadow-lg admin-card-class">
          <div class="card-header"> Add Ride Price. </div>
          <div class="card-body" style="width: 550px;">
            <form action="actionPages/transrateaction.php" method="post">
            <div class="input1">
              ...
              <tbody>
                <?php
                  ...
                  ?>
                    ...
                    <td><a href="actionPages/deleteBookingPrice.php?id=<?php echo $row['ratecalcId'];?>">Delete</a></td>
                    </tr>
                  <?php $i++;} ?>
              </tbody>
            </table>
